 ...
 */
package org.l2sm.vnets.api.event;

import org.l2sm.vnets.net.VirtualNetworkIntentService;
import org.l2sm.vnets.net.VnetService;
...
public abstract class AbstractVirtualListenerManager
    ...
    protected final VirtualNetworkIntentService manager;
    ...
    public AbstractVirtualListenerManager(VirtualNetworkIntentService manager,
                                          String networkId,
