...
public class VLinkNetworkIntent extends Intent {
    ...
    public static VLinkNetworkIntent.Builder builder() {
        return new Builder();
    }
    ...
    public static final class Builder extends Intent.Builder {
         ...
         */
        public VLinkNetworkIntent build() {
            return new VLinkNetworkIntent(
                    appId,
                    key,
                    connectPoints,
                    tunnelIds,
     ...
     */
    private VLinkNetworkIntent(ApplicationId appId,
            Key key,
            ConnectPoint[] connectPoints,
            long[] tunnelIds,
            int priority,
