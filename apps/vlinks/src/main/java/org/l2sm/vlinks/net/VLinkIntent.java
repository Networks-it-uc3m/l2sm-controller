...
public class VLinkIntent extends Intent {
    ...
    public static VLinkIntent.Builder builder() {
        return new Builder();
    }
    ...
    public static final class Builder extends Intent.Builder {
         ...
         */
        public VLinkIntent build() {
            return new VLinkIntent(
                    appId,
                    key,
                    one,
                    two,
     ...
     */
    private VLinkIntent(ApplicationId appId,
            Key key,
            ConnectPoint one,
            ConnectPoint two,
            Long tunnelId,
